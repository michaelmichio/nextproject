...
export default function Nav() {
    ...
    return (
        ...
        <div className="fixed w-full flex items-center justify-start h-14 text-white z-10">
            ...
            <div className="flex w-full items-center justify-start md:justify-center pl-3 w-14 md:w-64 h-14 bg-blue-800 dark:bg-gray-800 border-none">
                ...
                <ul className="flex items-center">
                    <li>
                        ...
                        >
                            ...
                            width="24"
                            height="24"
                            className="sun display-none fill-current text-gray-700 group-hover:text-gray-500 group-focus:text-gray-700 dark:text-gray-700 dark:group-hover:text-gray-500 dark:group-focus:text-gray-700"
                            ...
                            width="24"
                            height="24"
                            className="moon fill-current text-gray-700 group-hover:text-gray-500 group-focus:text-gray-700 dark:text-gray-700 dark:group-hover:text-gray-500 dark:group-focus:text-gray-700"
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                            viewBox="0 0 24 24"
                            stroke=""
