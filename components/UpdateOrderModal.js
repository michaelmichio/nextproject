...
export default function UpdateOrderModal({ isVisible, onClose, orderData }) {
    ...
    async function updateOrderHandler(e) {
        ...
        const updateOrderRes = await updateOrderReq.json();
                ...
                <div role="alert" className="container mx-auto w-11/12 md:w-2/3 max-w-lg">
                    <div className="relative py-8 px-5 md:px-10 bg-white shadow-md rounded border border-gray-400">
                        <form onSubmit={updateOrderHandler.bind(this)} action="">
                            ...
                            <input disabled required onChange={fieldHandler.bind(this)} name="customerId" id="customerId" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" value={orderData.customerId} />
                            <label htmlFor="nomorPolisi" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Nomor Polisi</label>
                            <input required onChange={fieldHandler.bind(this)} name="nomorPolisi" id="nomorPolisi" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" defaultValue={orderData.nomorPolisi} />
                            ...
                            <input onChange={fieldHandler.bind(this)} name="jenisKendaraan" id="jenisKendaraan" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" defaultValue={orderData.jenisKendaraan} />
                            <label htmlFor="nomorRangka" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Nomor Rangka</label>
                            <input onChange={fieldHandler.bind(this)} name="nomorRangka" id="nomorRangka" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" defaultValue={orderData.nomorRangka} />
                            <label htmlFor="nomorMesin" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Nomor Mesin</label>
                            <input onChange={fieldHandler.bind(this)} name="nomorMesin" id="nomorMesin" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" defaultValue={orderData.nomorMesin} />
                            <label htmlFor="nomorSPK" className="text-gray-800 text-sm font-bold leading-tight tracking-normal">Nomor SPK</label>
                            <input onChange={fieldHandler.bind(this)} name="nomorSPK" id="nomorSPK" className="mb-5 mt-2 text-gray-600 focus:outline-none focus:border focus:border-indigo-700 font-normal w-full h-10 flex items-center pl-3 text-sm border-gray-300 rounded border" defaultValue={orderData.nomorSPK} />
