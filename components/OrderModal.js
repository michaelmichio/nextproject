...
export default function OrderModal({ isVisible, onClose, orderData, token }) {
    ...
    async function createServiceHandler(e) {
        ...
        const createServiceRes = await createServiceReq.json();
    ...
    async function createSSGroupHandler() {
        ...
        const createSSGroupRes = await createSSGroupReq.json();
    ...
    return(
        ...
        <>
                            ...
                            <div className="flex-auto px-4 lg:px-10 py-10 pt-0">
                                ...
                                <div className="flex flex-wrap">
                                    <div className="w-full lg:w-12/12 px-4">
                                        ...
                                        <textarea type="text" className="border-0 px-3 py-3 placeholder-gray-300 text-gray-600 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150" rows="4" />
                                        </div>
                                    </div>
                                </div> */}
                                <hr className="mt-6 border-b-1 border-gray-300"/>
            ...
            <SSModal isVisible={ssModal} onClose={() => setVisibleSS(false)} ssGroupData={ssGroupData} token={token} />
        </>
